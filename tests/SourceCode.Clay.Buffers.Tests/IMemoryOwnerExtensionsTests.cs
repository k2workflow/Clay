...
namespace SourceCode.Clay.Buffers.Tests
{
    public static class IMemoryOwnerExtensionsTests
    {
        ...
        public static void MemoryPool_byte_WrapSlice_start_length_noop()
        {
            ...
            IMemoryOwner<byte> owner1 = pool.Rent(99);
            IMemoryOwner<byte> owner2 = owner1.Slice(0, 10);
            Assert.False(ReferenceEquals(owner1, owner2));

            IMemoryOwner<byte> owner3 = pool.Rent(0);
            IMemoryOwner<byte> owner4 = owner3.Slice(0, 0);
            Assert.True(ReferenceEquals(owner3, owner4));

            IMemoryOwner<byte> owner5 = pool.Rent(10);
            IMemoryOwner<byte> owner6 = owner5.Slice(0, owner5.Memory.Length);
        ...
        public static void MemoryPool_byte_WrapSlice_start_guards()
        {
            ...
            Assert.Throws<ArgumentOutOfRangeException>(() => IMemoryOwnerExtensions.Slice(owner1, -1));
            Assert.Throws<ArgumentOutOfRangeException>(() => IMemoryOwnerExtensions.Slice(owner1, owner1.Memory.Length + 1));
        }
        ...
        public static void MemoryPool_byte_WrapSlice_start_length_guards()
        {
            ...
            Assert.Throws<ArgumentOutOfRangeException>(() => IMemoryOwnerExtensions.Slice(owner1, -1, 0));
            Assert.Throws<ArgumentOutOfRangeException>(() => IMemoryOwnerExtensions.Slice(owner1, owner1.Memory.Length, 0));

            Assert.Throws<ArgumentOutOfRangeException>(() => IMemoryOwnerExtensions.Slice(owner1, 0, -1));
            Assert.Throws<ArgumentOutOfRangeException>(() => IMemoryOwnerExtensions.Slice(owner1, 0, owner1.Memory.Length + 1));
            Assert.Throws<ArgumentOutOfRangeException>(() => IMemoryOwnerExtensions.Slice(owner1, 1, owner1.Memory.Length));
        }
        ...
        public static void MemoryPool_byte_WrapSlice_start_length()
        {
            ...
            IMemoryOwner<byte> owner2 = owner1.Slice(10, 81);
