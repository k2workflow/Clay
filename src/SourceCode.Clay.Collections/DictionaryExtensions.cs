...
namespace SourceCode.Clay.Collections.Generic
{
    ...
    public static class DictionaryExtensions
    {
        ...
        /// <param name="comparer">The comparer to use to test for Value equality.</param>
        /// <returns></returns>
        public static bool NullableEquals<TKey, TValue>(this IReadOnlyDictionary<TKey, TValue> x, IReadOnlyDictionary<TKey, TValue> y, IEqualityComparer<TValue> comparer)
        {
            ...
            foreach (var yvp in y)
            {
                ...
                if (!comparer.Equals(yvp.Value, xVal)) return false; // Value: Uses the specified equality comparer
            }
