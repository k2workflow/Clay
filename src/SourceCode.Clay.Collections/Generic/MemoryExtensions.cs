...
namespace SourceCode.Clay.Collections.Generic
{
    ...
    public static class MemoryExtensions
    {
        ...
        /// <returns></returns>
        public static bool MemoryEquals<TSource>(ReadOnlyMemory<TSource> x, in ReadOnlyMemory<TSource> y, IEqualityComparer<TSource> comparer)
        {
        ...
        /// <param name="y">Memory 2</param>
        /// <returns></returns>
        public static bool MemoryEquals<TSource>(ReadOnlyMemory<TSource> x, in ReadOnlyMemory<TSource> y)
