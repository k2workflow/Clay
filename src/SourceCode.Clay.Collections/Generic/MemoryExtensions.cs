...
namespace SourceCode.Clay.Collections.Generic
{
    ...
    public static class MemoryExtensions
    {
        ...
        /// <returns></returns>
        public static bool MemoryEquals<TSource>(in this ReadOnlyMemory<TSource> x, in ReadOnlyMemory<TSource> y, IEqualityComparer<TSource> comparer)
        {
        ...
        /// <param name="y">Memory 2</param>
        /// <returns></returns>
        public static bool MemoryEquals<TSource>(in this ReadOnlyMemory<TSource> x, in ReadOnlyMemory<TSource> y)
