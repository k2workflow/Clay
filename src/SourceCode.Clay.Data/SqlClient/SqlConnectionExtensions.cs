...
namespace SourceCode.Clay.Data.SqlClient
{
    ...
    {
        /// <summary>
        /// Reopens the specified connection.
        /// </summary>
        ...
        /// <summary>
        /// Overload instance method SqlConnection.Open() with a method that allows
        /// the impersonation username to be passed in
        /// </summary>
        ...
        /// <summary>
        /// Overload instance method SqlConnection.Close() with a method that
        /// allows the impersonation context to be reverted
        /// </summary>
        /// <param name="sqlCon">The SqlConnection to use.</param>
