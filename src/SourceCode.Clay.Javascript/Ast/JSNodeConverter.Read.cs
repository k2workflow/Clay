...
namespace SourceCode.Clay.Javascript.Ast
{
    partial class JSNodeConverter
    {
        ...
        {
            if (@object.TryGetValue("regex", out var regexToken))
            {
        ...
        {
            if (!@object.TryGetValue("pattern", out var patternToken) || !(patternToken.Type == JTokenType.String))
                throw new InvalidOperationException("On a regex Literal AST, regex.pattern must be present and be a string.");
            if (!@object.TryGetValue("flags", out var flagsToken) || !(flagsToken.Type == JTokenType.String))
            ...
            var options = JSRegexOptions.None;
        ...
        {
            if (!@object.TryGetValue("left", out var leftToken) || !(leftToken.Type == JTokenType.Object))
                throw new InvalidOperationException("BinaryExpression must have left property of type object.");
            if (!@object.TryGetValue("operator", out var operatorToken) || !(operatorToken.Type == JTokenType.String))
                throw new InvalidOperationException("BinaryExpression must have operator property of type string.");
            if (!@object.TryGetValue("right", out var rightToken) || !(rightToken.Type == JTokenType.Object))
                throw new InvalidOperationException("BinaryExpression must have right property of type object.");

            var @operator = ConvertBinaryOperator((string)operatorToken);
        ...
        {
            if (!@object.TryGetValue("label", out var labelToken) || !(labelToken.Type == JTokenType.Object || labelToken.Type == JTokenType.Null))
        ...
        {
            if (!@object.TryGetValue("callee", out var calleeToken) || !(calleeToken.Type == JTokenType.Object))
                throw new InvalidOperationException("CallExpression must have callee property of type object.");
            if (!@object.TryGetValue("arguments", out var argumentsToken) || !(argumentsToken is JArray argumentsArray))
        ...
        {
            if (!@object.TryGetValue("param", out var paramToken) || !(paramToken.Type == JTokenType.Object))
                throw new InvalidOperationException("CatchClause must have param property of type object.");
            if (!@object.TryGetValue("body", out var bodyToken) || !(bodyToken is JObject bodyObject) ||
                !bodyObject.TryGetValue("type", out var bodyTypeToken) || bodyTypeToken.Type != JTokenType.String || (string)bodyTypeToken != "BlockStatement" ||
        ...
        {
            if (!@object.TryGetValue("test", out var testToken) || !(testToken.Type == JTokenType.Object))
                throw new InvalidOperationException("ConditionalExpression must have test property of type object.");
            if (!@object.TryGetValue("consequent", out var consToken) || !(consToken.Type == JTokenType.Object))
                throw new InvalidOperationException("ConditionalExpression must have consequent property of type object.");
            if (!@object.TryGetValue("alternate", out var altToken) || !(altToken.Type == JTokenType.Object))
        ...
        protected virtual JSDoWhileStatement ReadDoWhileStatement(JObject @object, JSDoWhileStatement existingValue, JsonSerializer serializer)
        {
            ...
            if (!@object.TryGetValue("body", out var bodyToken) || !(testToken.Type == JTokenType.Object))
        ...
        {
            if (!@object.TryGetValue("expression", out var expressionToken) || !(expressionToken.Type == JTokenType.Object))
        ...
        protected virtual JSForInStatement ReadForInStatement(JObject @object, JSForInStatement existingValue, JsonSerializer serializer)
        {
            ...
            if (!@object.TryGetValue("body", out var bodyToken) || !(bodyToken.Type == JTokenType.Object))
        ...
        {
            if (!@object.TryGetValue("init", out var initToken) || !(initToken.Type == JTokenType.Object || initToken.Type == JTokenType.Null))
                throw new InvalidOperationException("ForStatement must have property init of type object or null.");
            if (!@object.TryGetValue("test", out var testToken) || !(testToken.Type == JTokenType.Object || testToken.Type == JTokenType.Null))
                throw new InvalidOperationException("ForStatement must have property right of type object or null.");
            if (!@object.TryGetValue("update", out var updateToken) || !(updateToken.Type == JTokenType.Object || updateToken.Type == JTokenType.Null))
        ...
        {
            if (!@object.TryGetValue("id", out var idToken) || !(idToken.Type == JTokenType.Object))
                throw new InvalidOperationException("FunctionDeclaration must have property id of type object.");
            if (!@object.TryGetValue("params", out var paramsToken) || !(paramsToken is JArray paramsArray))
        ...
        {
            if (!@object.TryGetValue("id", out var idToken) || !(idToken.Type == JTokenType.Object || idToken.Type == JTokenType.Null))
        ...
        protected virtual JSIfStatement ReadIfStatement(JObject @object, JSIfStatement existingValue, JsonSerializer serializer)
        {
            ...
            if (!@object.TryGetValue("consequent", out var consequentToken) || !(testToken.Type == JTokenType.Object))
                throw new InvalidOperationException("IfStatement must have property consequent of type object.");
            if (!@object.TryGetValue("alternate", out var alternateToken) || !(alternateToken.Type == JTokenType.Object || alternateToken.Type == JTokenType.Null))
        ...
        {
            if (!@object.TryGetValue("label", out var labelToken) || !(labelToken.Type == JTokenType.Object))
        ...
        {
            if (!@object.TryGetValue("computed", out var computedToken) || !(computedToken.Type == JTokenType.Boolean))
                throw new InvalidOperationException("MemberExpression must have property computed of type boolean.");
            if (!@object.TryGetValue("object", out var objectToken) || !(objectToken.Type == JTokenType.Object))
                throw new InvalidOperationException("MemberExpression must have property object of type object.");
            if (!@object.TryGetValue("property", out var propertyToken) || !(propertyToken.Type == JTokenType.Object))
        ...
        {
            if (!@object.TryGetValue("kind", out var kindToken) || !(kindToken.Type == JTokenType.String))
                throw new InvalidOperationException("Property must have kind property of type string.");
            if (!@object.TryGetValue("key", out var keyToken) || !(keyToken.Type == JTokenType.Object))
                throw new InvalidOperationException("Property must have key property of type object.");
            if (!@object.TryGetValue("value", out var valueToken) || !(valueToken.Type == JTokenType.Object))
                throw new InvalidOperationException("Property must have value property of type object.");

            var kind = ConvertPropertyKind((string)kindToken);
        ...
        {
            if (!@object.TryGetValue("argument", out var argumentToken) || !(argumentToken.Type == JTokenType.Object || argumentToken.Type == JTokenType.Null))
        ...
        protected virtual JSSwitchCase ReadSwitchCase(JObject @object, JSSwitchCase existingValue, JsonSerializer serializer)
        {
            ...
            if (!@object.TryGetValue("consequent", out var consequentToken) || !(consequentToken is JArray consequentArray))
        ...
        {
            if (!@object.TryGetValue("discriminant", out var testToken) || !(testToken.Type == JTokenType.Object))
                throw new InvalidOperationException("SwitchStatement must have discriminant property of type object.");
            if (!@object.TryGetValue("cases", out var casesToken) || !(casesToken is JArray casesArray))
        ...
        {
            if (!@object.TryGetValue("argument", out var argumentToken) || !(argumentToken.Type == JTokenType.Object))
        ...
        {
            if (!@object.TryGetValue("block", out var bodyToken) || !(bodyToken is JObject bodyObject) ||
                !bodyObject.TryGetValue("type", out var bodyTypeToken) || !(bodyTypeToken.Type == JTokenType.String && (string)bodyTypeToken == "BlockStatement") ||
                !bodyObject.TryGetValue("body", out bodyToken) || !(bodyToken is JArray bodyArray))
                throw new InvalidOperationException("TryStatement must have property block of block statement.");

            if (!@object.TryGetValue("handler", out var handlerToken) || !(handlerToken.Type == JTokenType.Object || handlerToken.Type == JTokenType.Null))
                throw new InvalidOperationException("TryStatement must have property handler of type object or null.");

            if (!@object.TryGetValue("finalizer", out var finalizerToken) || !(finalizerToken.Type == JTokenType.Object || finalizerToken.Type == JTokenType.Null))
        ...
        {
            if (!@object.TryGetValue("prefix", out var prefixToken) || !(prefixToken.Type == JTokenType.Boolean))
            ...
            var argument = ReadJson(argumentToken, existingValue?.Expression, serializer);
            var @operator = ConvertUnaryOperator((bool)prefixToken, (string)operatorToken);
        ...
        {
            if (!@object.TryGetValue("kind", out var kindToken) && !(kindToken.Type == JTokenType.String && (string)kindToken == "var"))
        ...
        protected virtual JSWithStatement ReadWithStatement(JObject @object, JSWithStatement existingValue, JsonSerializer serializer)
        {
            ...
            if (!@object.TryGetValue("body", out var bodyToken) || !(objectToken.Type == JTokenType.Object))
