...
namespace SourceCode.Clay.Buffers.Tests
{
    public static class BufferComparerTests
    {
        ...
        {
            Assert.Equal(HashCode.FnvNull, BufferComparer.Default.GetHashCode(default));
        }
        ...
        {
            Assert.Equal(HashCode.FnvEmpty, BufferComparer.Default.GetHashCode(Array.Empty<byte>()));
            Assert.Equal(HashCode.FnvEmpty, BufferComparer.DefaultSpan.GetHashCode(default));
        }
