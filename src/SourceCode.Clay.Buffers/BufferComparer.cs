...
namespace SourceCode.Clay.Buffers
{
    ...
    public static class BufferComparer
    {
        ...
        ///   with default fidelity.
        /// </summary>
        /// <value>The default instance of the buffer comparer that uses FNV.</value>
        ...
        /// <summary>
        ///   Gets the default instance of the <see cref="ReadOnlySpan{T}"/> buffer comparer that
        ///   uses FNV with default fidelity. This also supports comparison of <see cref="byte[]"/>
        ///   and <see cref="ArraySegment{T}"/> due to their implicit conversion to <see cref="ReadOnlySpan{T}"/>.
        /// </summary>
        /// <value>The default instance of the buffer comparer that uses FNV.</value>
        ...
        {
            // From
            // https://github.com/dotnet/corefx/blob/master/src/System.Memory/src/System/ReadOnlySpan.cs
            // public static bool operator == Returns true if left and right point at the same memory
            // and have the same length. Note that this does *not* check to see if the *contents* are equal.
            if (x == y) return 0;
