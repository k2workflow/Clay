...
{
    /// <summary>
    /// Represents a way to compare the contents of <see cref="ReadOnlySpan{T}{T}"/>.
    /// </summary>
    public sealed class ReadOnlySpanComparer : BufferComparer<ReadOnlySpan<byte>>
    {
        #region Constructors
        ...
        /// disable the limit.
        /// </param>
        public ReadOnlySpanComparer(int hashCodeFidelity)
