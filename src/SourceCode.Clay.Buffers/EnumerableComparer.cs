...
{
    /// <summary>
    /// Represents a way to compare the contents of <see cref="IEnumerable{T}"/>.
    /// </summary>
    public sealed class EnumerableComparer : BufferComparer<IEnumerable<byte>>
    {
        #region Constructors
        ...
        /// disable the limit.
        /// </param>
        public EnumerableComparer(int hashCodeFidelity)
