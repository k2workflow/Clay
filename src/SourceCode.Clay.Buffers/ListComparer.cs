...
{
    /// <summary>
    /// Represents a way to compare the contents of <see cref="IList{T}"/>.
    /// </summary>
    public sealed class ListComparer : BufferComparer<IList<byte>>
    {
        #region Constructors
        ...
        /// disable the limit.
        /// </param>
        public ListComparer(int hashCodeFidelity)
