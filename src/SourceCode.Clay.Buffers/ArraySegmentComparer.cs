...
{
    /// <summary>
    /// Represents a way to compare the contents of <see cref="ArraySegment{T}"/>.
    /// </summary>
    public sealed class ArraySegmentComparer : BufferComparer<ArraySegment<byte>>
    {
        #region Constructors
        ...
        /// disable the limit.
        /// </param>
        public ArraySegmentComparer(int hashCodeFidelity)
        ...
        /// </returns>
        public override int Compare(ArraySegment<byte> x, ArraySegment<byte> y)
            => CompareArraySegment(x, y);
        ...
        public override int GetHashCode(ArraySegment<byte> obj)
        {
            ...
            if (HashCodeFidelity > 0 && obj.Count > HashCodeFidelity)
                span = new ReadOnlySpan<byte>(obj.Array, obj.Offset, HashCodeFidelity);
