...
namespace SourceCode.Clay
{
    ...
    public static class BoolExtensions
    {
        ...
        private static bool EvaluateImpl(uint value)
        {
            ...
            // byte#             4         3         2    1
            //                   1000 0000 0000 0000 0..0 0..0000
            val |= val >> 01; // 1100 0000 0000 0000 0..0 0..0000
            val |= val >> 02; // 1111 0000 0000 0000 0..0 0..0000
            val |= val >> 04; // 1111 1111 0000 0000 0..0 0..0000
            val |= val >> 08; // 1111 1111 1111 1111 0..0 0..0000
            val |= val >> 16; // 1111 1111 1111 1111 1..1 1..1111

            val = val & 1;    // 0000 0000 0000 0000 0..0 0..0001
        ...
        private static bool EvaluateImpl(ulong value)
        {
            ...
            val |= val >> 04; // 1111 1111 0000 0000 0..0 0..0000
            val |= val >> 08; // 1111 1111 1111 1111 0..0 0..0000
            val |= val >> 16; // 1111 1111 1111 1111 1..1 0..0000
            val |= val >> 32; // 1111 1111 1111 1111 1..1 1..1111
