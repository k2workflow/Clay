...
namespace SourceCode.Clay
{
    ...
    public sealed class SafeRandom : Random
    {
        ...
        ///   name="maxValue"/> must be greater than or equal to 0.
        /// </param>
        /// <returns>
        ///   A 32-bit signed integer that is greater than or equal to 0, and less than <paramref
        ///   name="maxValue"/>; that is, the range of return values ordinarily includes 0 but not
        ///   <paramref name="maxValue"/>. However, if <paramref name="maxValue"/> equals 0,
        ...
        ///   <paramref name="minValue"/> but not <paramref name="maxValue"/>. If <paramref
        ///   name="minValue"/> equals <paramref name="maxValue"/>, <paramref name="minValue"/> is returned.
        /// </returns>
