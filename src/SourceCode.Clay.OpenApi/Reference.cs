...
namespace SourceCode.Clay.OpenApi
{
    ...
    public struct Reference : IEquatable<Reference>
    {
        ...
        ///   <paramref name="url"/> is not in a format compliant with the Open API specification.
        /// </exception>
        ...
        /// <summary>
        ///   Converts the URL representation of a reference to its structured equivalent. A return
        ///   value indicates whether the conversion succeeded.
        /// </summary>
        /// <param name="url">A URL containing a reference to convert.</param>
        /// <param name="result">
        ///   When this method returns, contains the structured equivalent of the reference contained
        ///   in <paramref name="url"/>, if the conversion succeeded, or default if the conversion
        ///   failed. The conversion fails if the <paramref name="url"/> parameter is not in a format
        ///   compliant with the Open API specification. This parameter is passed uninitialized; any
        ///   value originally supplied in result will be overwritten.
        /// </param>
        /// <returns>
        ///   <c>true</c> if <paramref name="url"/> was converted successfully; otherwise, <c>false</c>.
        /// </returns>
        ...
        /// <summary>
        ///   Returns reference formatted as a string.
        /// </summary>
