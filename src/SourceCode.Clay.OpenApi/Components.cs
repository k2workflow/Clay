...
namespace SourceCode.Clay.OpenApi
{
    ...
    public class Components : IEquatable<Components>
    {
        ...
        ///   The object that holds reusable <see cref="ParameterBody"/> instances.
        /// </param>
        /// <param name="examples">The object that holds reusable <see cref="Example"/> instances.</param>
        /// <param name="requestBodies">
        ///   The object that holds reusable <see cref="RequestBody"/> instances.
        /// </param>
        /// <param name="headers">
        ///   The object that holds reusable header <see cref="ParameterBody"/> instances.
        /// </param>
        /// <param name="securitySchemes">
        ///   The object that holds reusable <see cref="SecurityScheme"/> instances.
        /// </param>
