...
namespace SourceCode.Clay.OpenApi
{
    ...
    public class ParameterBody : IEquatable<ParameterBody>
    {
        ...
        /// <summary>
        ///   Gets the value which indicates how the parameter value will be serialized depending on
        ...
        /// <param name="style">
        ///   The value which indicates how the parameter value will be serialized depending on the
        ...
        public override int GetHashCode()
        {
            unchecked
            {
                ...
                hc = hc * 21 + StringComparer.Ordinal.GetHashCode(Description);
