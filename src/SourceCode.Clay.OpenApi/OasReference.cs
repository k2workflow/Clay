...
namespace SourceCode.Clay.OpenApi
{
    ...
    public readonly struct OasReference : IEquatable<OasReference>
    {
        ...
        public OasReference(JsonPointer pointer)
        {
        ...
        /// <summary>
        /// Creates a new external <see cref="OasReference"/> value.
        /// </summary>
        /// <param name="url">The external reference URL.</param>
        public OasReference(Uri url)
            : this(url, default)
        {
        }
        ...
        public static bool operator ==(OasReference reference1, OasReference reference2) => reference1.Equals(reference2);
        ...
        /// <param name="reference2">The reference2.</param>
        /// <returns>The result of the operator.</returns>
        public static bool operator !=(OasReference reference1, OasReference reference2) => !(reference1 == reference2);

        /// <summary>Indicates whether this instance and a specified object are equal.</summary>
        /// <param name="obj">The object to compare with the current instance.</param>
        /// <returns>true if <paramref name="obj">obj</paramref> and this instance are the same type and represent the same value; otherwise, false.</returns>
        public override bool Equals(object obj) => obj is OasReference o && Equals(o);
        ...
        public static bool TryParseUrl(Uri url, out OasReference result)
        {
            ...
            result = new OasReference(url, pointer);
            return true;
        }

        /// <summary>
        /// Performs an implicit conversion from <see cref="SourceCode.Clay.Json.Pointers.JsonPointer" /> to <see cref="SourceCode.Clay.OpenApi.OasReference" />.
        /// </summary>
        /// <param name="pointer">The pointer.</param>
        /// <returns>The result of the conversion.</returns>
        public static implicit operator OasReference(JsonPointer pointer) => pointer.Count == 0 ? default : new OasReference(pointer);

        /// <summary>
        /// Performs an implicit conversion from <see cref="System.Uri" /> to <see cref="SourceCode.Clay.OpenApi.OasReference" />.
        /// </summary>
        ...
        /// <param name="url">The URL.</param>
        /// <returns>The result of the conversion.</returns>
        public static implicit operator OasReference(string url)
        {
