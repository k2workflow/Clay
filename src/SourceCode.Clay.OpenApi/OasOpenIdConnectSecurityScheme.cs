...
namespace SourceCode.Clay.OpenApi
{
    ...
    /// </summary>
    public class OasOpenIdConnectSecurityScheme : OasSecurityScheme, IEquatable<OasOpenIdConnectSecurityScheme>
    {
        #region Properties
        ...
        /// <summary>
        /// Creates a new instance of the <see cref="OasOpenIdConnectSecurityScheme"/>.
        /// </summary>
        ...
        public OasOpenIdConnectSecurityScheme(
        ...
        public static bool operator ==(OasOpenIdConnectSecurityScheme scheme1, OasOpenIdConnectSecurityScheme scheme2)
        {
        ...
        public override bool Equals(object obj)
            => obj is OasOpenIdConnectSecurityScheme other
            && Equals(other);

        /// <summary>Indicates whether the current object is equal to another object of the same type.</summary>
        /// <param name="other">An object to compare with this object.</param>
        /// <returns>true if the current object is equal to the <paramref name="other">other</paramref> parameter; otherwise, false.</returns>
        public bool Equals(OasOpenIdConnectSecurityScheme other)
        {
