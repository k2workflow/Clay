...
namespace SourceCode.Clay.OpenApi
{
    ...
    public readonly struct OasScalarValue : IEquatable<OasScalarValue>, IFormattable
    {
        ...
        public OasScalarValue(bool boolean)
        {
            ...
            _number = new Number(boolean.ToByte());
            _string = null;
        }
        ...
        /// <param name="format">The format to use.   -or-   A null reference (Nothing in Visual Basic) to use the default format defined for the type of the <see cref="System.IFormattable"></see> implementation.</param>
