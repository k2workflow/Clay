...
namespace SourceCode.Clay.OpenApi
{
    ...
    public struct ResponseKey : IEquatable<ResponseKey>
    {
        ...
        /// <summary>
        ///   Gets the response key for <see cref="HttpStatusCode.Accepted"/>.
        /// </summary>
        public static ResponseKey Accepted { get; } = new ResponseKey(202);

        /// <summary>
        ///   Gets the response key for <see cref="HttpStatusCode.Ambiguous"/>.
        /// </summary>
        public static ResponseKey Ambiguous { get; } = new ResponseKey(300);

        /// <summary>
        ///   Gets the response key for <see cref="HttpStatusCode.BadGateway"/>.
        /// </summary>
        public static ResponseKey BadGateway { get; } = new ResponseKey(502);

        /// <summary>
        ///   Gets the response key for <see cref="HttpStatusCode.BadRequest"/>.
        /// </summary>
        public static ResponseKey BadRequest { get; } = new ResponseKey(400);

        /// <summary>
        ///   Gets the response key for <see cref="HttpStatusCode.Conflict"/>.
        /// </summary>
        public static ResponseKey Conflict { get; } = new ResponseKey(409);

        /// <summary>
        ///   Gets the response key for <see cref="HttpStatusCode.Continue"/>.
        /// </summary>
        public static ResponseKey Continue { get; } = new ResponseKey(100);

        /// <summary>
        ///   Gets the response key for <see cref="HttpStatusCode.Created"/>.
        /// </summary>
