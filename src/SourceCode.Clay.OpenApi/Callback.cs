...
namespace SourceCode.Clay.OpenApi
{
    ...
    ///   map is a <see cref="Path"/> that describes a set of requests that may be initiated by the
    ///   API provider and the expected responses. The key value used to identify the callback object
    ...
    public class Callback : IReadOnlyDictionary<CompoundExpression, Referable<Path>>, IEquatable<Callback>
    {
        ...
        ///   <paramref name="key">key</paramref> is null.
        /// </exception>
        /// <exception cref="T:System.Collections.Generic.KeyNotFoundException">
        ///   The property is retrieved and <paramref name="key">key</paramref> is not found.
        /// </exception>
        ...
        ///   found; otherwise, the default value for the type of the value parameter. This parameter
        ///   is passed uninitialized.
        /// </param>
        /// <returns>
        ///   true if the object that implements the <see
        ///   cref="T:System.Collections.Generic.IReadOnlyDictionary`2"></see> interface contains an
        ...
        /// <summary>
        ///   Gets as hash code suitable for storing this object in a hash table.
        /// </summary>
