...
namespace SourceCode.Clay.Json
{
    public static partial class JsonReaderExtensions
    {
        ...
        /// <summary>
        /// Reads the current token value as a <see cref="UInt64"/>.
        /// </summary>
        /// <param name="jr">The <see cref="JsonReader"/> instance.</param>
        /// <returns>The integer value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ulong AsUInt64(this JsonReader jr)
            => (ulong)(long)jr.Value;

        /// <summary>
        /// Reads the current token value as a nullable <see cref="UInt64"/>.
        /// Returns <see langword="null"/> if the Json value is null.
        /// </summary>
        /// <param name="jr">The <see cref="JsonReader"/> instance.</param>
        /// <returns>The integer value or null.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ulong? AsUInt64Nullable(this JsonReader jr)
            => jr.TokenType == JsonToken.Null ? null : (ulong?)(long)jr.Value;
        ...
        /// <returns>The integer value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static sbyte AsSByte<TEnum>(this JsonReader jr)
            => (sbyte)(long)jr.Value;
        ...
        /// <returns>The integer value or null.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static sbyte? AsSByteNullable<TEnum>(this JsonReader jr)
